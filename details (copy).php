			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form class="form-horizontal form-bordered" action="mainfile.php" method="post">
						<div class="form-group">
							<div class="col-md-6">
								<input type="text" list="department_ids" name="deptID1" class="form-control input-rounded" id="" placeholder="Department Id*">
									<datalist id="department_ids">
<!-- Edited -->
<?php
							...
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" list="department_ids_suggestion"
										class="form-control input-rounded" name="SemDeptID" id=""
										placeholder="Department Id*">
...
<!-- edited -->
							...
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" name="SemYear" list="academic_year_suggestion"
...
<!-- edited -->
							...
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" name="DivYear" list="academic_year_suggestion"
										class="form-control input-rounded" id=""
										placeholder="Academic Year*">
									<datalist id="academic_year_suggestion">
<!-- Edited -->
...
<!-- edited -->
							...
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" name="DivSem" list="sem_suggestion"
										class="form-control input-rounded" id=""
										placeholder="Academic Year*">
									<datalist id="sem_suggestion">
<!-- Edited -->
<?php
...
<!-- edited -->
							...
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" name="BatchYear" list="academic_year_suggestion"
										class="form-control input-rounded" id=""
										placeholder="Academic Year*">
									<datalist id="academic_year_suggestion">
<!-- Edited -->
...
<!-- edited -->
							...
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" name="BatchSem" list="sem_suggestion"
										class="form-control input-rounded" id=""
										placeholder="Semester*">
									<datalist id="sem_suggestion">
<!-- Edited -->
...
<!-- edited -->
							...
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" name="BatchDiv" list="div_suggestion"
										class="form-control input-rounded" id=""
										placeholder="Division*">
									<datalist id="div_suggestion">
<!-- Edited -->
<?php
	    ...
	    while ($row   = mysqli_fetch_array($result))
	    {
		echo "<option value=".$row['division'].">";
	    }
?>
<!-- edited -->
									</datalist>
...
<!-- edited -->
							...
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" list="Act_RollNO_suggestion1"
										class="form-control input-rounded letterUpper" id="inputRounded"
										placeholder="Batch*" name="ActiveBatch1">
									<datalist id="Act_RollNO_suggestion1">
<!-- Edited -->
<?php
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal form-bordered" enctype="multipart/form-data"  action="mainfile.php" method="post">
							...
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" list="semster_suggestion"
										class="form-control input-rounded letterCapitalize" name="FacName" id="inputRounded"
										placeholder="Faculty Name">
								</div>
							</div>
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" list="department_suggestion"
										class="form-control input-rounded letterUpper" id="inputRounded" name="FacDeptID" 
										placeholder="Department Id*">
